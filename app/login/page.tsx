...
// import { useState, useEffect } from 'react';
// import StudentForm from '../Components/StudentForm';     // Fixed: Capital S
...
//       return <TeacherForm onContinue={() => setCurrentStep('verify')} />;
//     }
//     if (selectedRole === 'parent') {
//       return <ParentForm onContinue={() => setCurrentStep('verify')} />;
//     }
//     return <StudentForm onContinue={() => setCurrentStep('verify')} />;
//   }
...
//             <h3 className="text-2xl font-semibold text-gray-800 mb-4">Student</h3>
//             <ul className="space-y-3 text-gray-600">
//               <li className="flex items-start"><span className="text-green-500 mr-2">Bullet</span>Students can register</li>
//               <li className="flex items-start"><span className="text-green-500 mr-2">Bullet</span>Students can ask teachers for tutor</li>
//               <li className="flex items-start"><span className="text-green-500 mr-2">Bullet</span>Students can join class</li>
//             </ul>
//           </div>
...
//             <h3 className="text-2xl font-semibold text-gray-800 mb-4">Parent</h3>
//             <ul className="space-y-3 text-gray-600">
//               <li className="flex items-start"><span className="text-green-500 mr-2">Bullet</span>Register your child</li>
//               <li className="flex items-start"><span className="text-green-500 mr-2">Bullet</span>Find qualified tutors</li>
//               <li className="flex items-start"><span className="text-green-500 mr-2">Bullet</span>Track progress</li>
//             </ul>
//           </div>
...
//             <h3 className="text-2xl font-semibold text-gray-800 mb-4">Teacher</h3>
//             <ul className="space-y-3 text-gray-600">
//               <li className="flex items-start"><span className="text-green-500 mr-2">Bullet</span>Teach students online</li>
//               <li className="flex items-start"><span className="text-green-500 mr-2">Bullet</span>Set your own rates</li>
//               <li className="flex items-start"><span className="text-green-500 mr-2">Bullet</span>Flexible schedule</li>
//             </ul>
//           </div>
//         </div>
...
import StudentForm from '../Components/studentform';
import TeacherForm from '../Components/TeacherForm';
import ParentForm from '../Components/ParentForm';   // NEW
import VerifyIdentity from '../Components/VerifyIdentity';
import SubmitForm from '../Components/SubmitForm';
      ...
      <div className="max-w-6xl w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Parent</h3>
            <ul className="space-y-3 text-gray-600">
              <li className="flex items-start"><span className="text-green-500 mr-2">•</span>Register your child</li>
              <li className="flex items-start"><span className="text-green-500 mr-2">•</span>Find qualified tutors</li>
              <li className="flex items-start"><span className="text-green-500 mr-2">•</span>Track progress</li>
            </ul>
          </div>
          ...
          >
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">Teacher</h3>
            <ul className="space-y-3 text-gray-600">
              <li className="flex items-start"><span className="text-green-500 mr-2">•</span>Teach students online</li>
              <li className="flex items-start"><span className="text-green-500 mr-2">•</span>Set your own rates</li>
              <li className="flex items-start"><span className="text-green-500 mr-2">•</span>Flexible schedule</li>
            </ul>
          </div>
        </div>
